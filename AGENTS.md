...
- ICP 备案号当前为 `鲁ICP备2026031639号`，展示位置在 `app/src/components/layout/Footer.tsx`，链接应指向 `https://beian.miit.gov.cn/`。
- 官网域名当前为 `aqztjx.top`，静态信息中的 canonical、Open Graph URL 和结构化数据 URL 位于 `app/index.html`。
