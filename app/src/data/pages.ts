...
> = {
  'oil-press': {
    ...
    intro:
      '榨油设备面向花生、大豆、菜籽、米糠等油料压榨，也覆盖白土过滤、废油泥回收再利用和预处理压榨等工况。',
  ...
  processing: {
    ...
    intro:
      '处理设备服务榨油和物料加工前后工序，帮助完成筛选分级、粉碎、蒸炒、自动上料和脱壳处理。',
  ...
  bagging: {
    ...
    intro:
      '装袋设备面向煤炭等散装物料的装袋和装车场景，重点围绕定量、输送、现场占地和发货节奏确认配置。',
...
export const pageRoutes: PageMeta[] = [
  {
    ...
    description:
      '安丘市增涛机械有限公司成立于2012年，坐落于山东省潍坊市，主营螺旋榨油机、液压榨油机、饲料机械、煤炭装袋机等设备。',
    h1: siteInfo.name,
    kind: 'home',
    navLabel: '首页',
    priority: '1.0',
  ...
  },
  {
    ...
    description:
      '了解安丘市增涛机械有限公司的成立时间、制造属性、主营设备、山东潍坊安丘生产地址和联系方式。',
    h1: '公司介绍',
    kind: 'about',
    navLabel: '公司介绍',
    priority: '0.8',
  ...
  },
  {
    ...
    description:
      '安丘增涛机械产品分类包括榨油设备、处理设备和装袋设备，覆盖压榨、筛选、粉碎、炒制、上料、脱壳和煤炭装袋。',
    h1: '产品分类',
    kind: 'products',
    navLabel: '产品分类',
    priority: '0.9',
