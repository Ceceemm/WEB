...
export const products: Product[] = [
  ...
  // 装袋设备系列
  { id: 'p14', name: '煤炭装袋机', category: 'bagging', description: '煤炭定量装袋设备', image: '/images/products/product-14.jpg', featured: true },
  ...
  { id: 'p23', name: '设备调试', category: 'processing', description: '设备出厂前调试检测', image: '/images/products/product-23.jpg' },
  { id: 'p24', name: '装袋设备展示', category: 'bagging', description: '装袋设备全方位展示', image: '/images/products/product-24.jpg' },
  { id: 'p25', name: '榨油设备展示', category: 'oil-press', description: '榨油设备多角度展示', image: '/images/products/product-25.jpg' },
  ...
  { id: 'p28', name: '煤炭装袋设备', category: 'bagging', description: '煤炭装袋设备工作场景', image: '/images/products/product-28.jpg' },
  { id: 'p29', name: '生产现场实拍', category: 'processing', description: '设备生产车间实拍', image: '/images/products/product-29.jpg' },
